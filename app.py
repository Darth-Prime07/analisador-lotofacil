# app.py (v3.7 - Painel de Estratégias Completo)
...
modo_app = st.sidebar.radio(
    ...
    ["Gerador de Jogos", "Simulador de Estratégias", "Painel de Estratégias", "Laboratório de IA"],
    key="navigation"
)
            ...
            with col2:
                ...
                if st.button("Rodar Simulação de Desempenho para esta Estratégia"):
                    ...
                    with st.spinner("Realizando backtest..."):
                        # O método rodar_simulacao espera uma lista de estratégias
                        resultados_sim = analisador.rodar_simulacao()
                    
                    # Extrai os resultados para a única estratégia simulada
                    res_est = resultados_sim['resultados_por_estrategia'][estrategia_obj['nome']]
                    ...
                    ax.plot(resultados_sim['historico_lucro'], marker='o', linestyle='-', color='royalblue')
